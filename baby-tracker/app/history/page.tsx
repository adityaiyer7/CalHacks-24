...
const History = () => {
    const botMessages=["Hello", "Hi", "How are you?", "I am fine", "What about you?", "I am good"];
    const userMessages = ["Hello", "Hi", "How are you?", "I am fine", "What about you?", "I am good"];
    return (
                ...
                <div className="flex flex-col justify-center items-center w-full h-full p-3">
                    <div className="flex justify-center items-center w-full md:w-3/4 h-full">
                        <div className="flex flex-col justify-between items-center h-full w-full">
                            <div id="chat-box" className="w-full h-full my-1">
