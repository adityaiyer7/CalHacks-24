            ...
            <div className="flex flex-col justify-center items-center">
                <ul className="w-11/12 h-auto">
                    {navItems.map((item) => (
                        <li
                            key={item.name}
                            className={`flex flex-row items-center hover:opacity-70 hover:cursor-pointer hover:animate-wiggle rounded-lg shadow-lg p-2 my-2 ${selectedNav === item.name ? 'border-2 border-primary' : ''
                                }`}
